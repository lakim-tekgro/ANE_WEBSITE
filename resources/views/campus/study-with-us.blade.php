  ...
  <body>
        ...
        <div class="study-page">
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                <div class="py-5">
                  <h1 class="admssion-font text-white" style="font-weight: 800">
                    Which course is best for you?
                  </h1>
                  <p class="text-white mt-4" style="font-size: 14px">
                    Don't choose just any path – choose your future. Discover
                    study options to match your interests, passions and career
                    goals.
                  </p>
                  <div class="mt-5">
                    <a class="custom-button me-2" href="#">Hospitality </a>
                    <a class="custom-button me-2" href="#"
                      >Health Services
                    </a>
                    <a class="custom-button me-2" href="#"
                      >Information Technology
                    </a>
                    <a class="custom-button me-2" href="#">Leadership </a>
                  </div>
                </div>
              </div>
    ...
    <section class="top-padding">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="d-flex align-items-center gap-2 start">
              <div class="sectionheader d-block fw-bold">Study at ANE</div>
              <span class="sectionstyle"></span>
            </div>
            <h4 class="my-3 contentheader">Your Journey Starts Here</h4>
            <p>
              Our campus is an experience, a place to belong, to live, learn and
              discover you. Your time with us will introduce you to enriching
              courses and lifelong friends and see you collaborating with other
              passionate people from across Australia and other countries around
              the world.
            </p>
            <div class="mt-lg-5" data-aos="fade-up" data-aos-delay="100">
              <a class="custom-button" href="about-us.html"
                >Why Study at ANE<i
                  class="fa fa-angle-double-right ms-2 text-white"
                ></i>
              </a>
          ...
          <div class="col-lg-6">
            <div class="d-lg-block d-none">
              <video
                src="./video/sydney-tour.mp4"
                controls
                poster="./img/sydney-campus.svg"
              ></video>
            </div>
          </div>
        </div>
    ...
    <!--Qualify Section-->
    <section class="top-padding">
      <div class="bg-color py-lg-5 py-md-5 py-3">
        <div class="container">
          <div class="row">
            <div class="col-lg-6 col-md-6">
              <div class="col-lg-10 mt-lg-0 mt-md-4">
                <img
                  src="./img/pre-qualify.jpg"
                  alt="qualify"
                  class="studyimage"
                />
              </div>
            ...
            <div class="col-lg-6 col-md-6">
              <div>
                <h4
                  ...
                  data-aos-delay="100"
                >
                  Pre-Qualify for a Partial Scholarship
                </h4>
                <p>
                  Meet with one of our counsellors today to see if you are able
                  to qualify for a partial scholarship. We will take into
                  account your academic history, experience and chosen course as
                  well as other factors. Please click to fill out the form and
                  apply
                </p>
                <div class="mt-lg-5" data-aos="fade-up" data-aos-delay="100">
                  <a class="custom-button" href="fees.html"
    ...
    <section class="top-padding">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-6 order-md-2 order-lg-2">
            <div class="col-lg-10">
              <img src="./img/enrolment.svg" alt="enrolment" />
            </div>
          </div>
          <div class="col-lg-6 col-md-6 order-md-1 order-lg-1">
            ...
            <p>
              Are you ready to apply with ANE College and begin your education
              to an exciting career in Australia! If so please click to follow
              the clink to submit your application to our enrolment team. We
              will assess your application and get back to you within 5 working
              days.
            </p>
            <div
              class="mt-lg-5 mb-lg-0 mb-4"
              data-aos="fade-up"
              data-aos-delay="100"
            >
              <a class="custom-button mb-lg-0 mb-3" href="#"
            ...
            <div class="col-lg-6 col-md-6">
              <div>
                ...
                <div class="mt-5" data-aos="fade-up" data-aos-delay="100">
                  <a class="custom-button" href="campus-tour.html"
                    >Campus Tour<i
                      class="fa fa-angle-double-right ms-2 text-white"
                    ></i>
                  </a>
    ...
    <section class="top-padding">
      <div class="container">
        <div class="d-flex align-items-center gap-2 justify-content-center">
          <span class="sectionstyle"></span>
          <div class="sectionheader d-block fw-bold">Study Options</div>
          <span class="sectionstyle"></span>
        </div>
        <h4
        ...
        <div class="row gy-3">
            ...
            <a class="text-decoration-none" href="technology.html">
              <div class="card border-0 shadow h-100">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    Building the future in new era of technology
                  </p>
                </div>
              </div>
            </a>
          ...
          <div class="col-lg-3 col-md-6">
            <a class="text-decoration-none" href="leadership.html">
              <div class="card border-0 shadow h-100">
                ...
                />
                <div class="card-body">
                  <h5 class="card-title fw-bold">Leadership</h5>
                  <p class="card-text">Creating Leaders of Tomorrow, Today</p>
                </div>
              </div>
            </a>
          </div>
          <div class="col-lg-3 col-md-6">
            <a class="text-decoration-none" href="health-services.html">
              <div class="card border-0 shadow h-100">
                <img src="./img/health.png" class="card-img-top" alt="course" />
                <div class="card-body">
                  <h5 class="card-title fw-bold">Health Services</h5>
                  <p class="card-text">
                    Navigating education on health and medicine
                  </p>
                </div>
              </div>
            </a>
          ...
          <div class="col-lg-3 col-md-6">
            <a class="text-decoration-none" href="hospitality.html">
              <div class="card border-0 shadow h-100">
                <img
                  src="./img/hospitality.png"
                  class="card-img-top"
                  alt="course"
                />
                <div class="card-body">
                  <h5 class="card-title fw-bold">Hospitality</h5>
                  <p class="card-text">
                    Unlocking Leadership Potential Inspire, Leed, Succeed
                  </p>
                </div>
              </div>
            </a>
      ...
      <div class="container">
        ...
        >
          ...
          >
          <div>
            <button class="btn btn-light rounded-pill mt-3 mt-lg-0">
    ...
    <section class="top-padding">
      <div class="aboutbg py-4">
        <div class="container">
          <div class="d-flex align-items-center gap-2 justify-content-center">
            <span class="sectionstyle"></span>
            <div class="sectionheader d-block fw-bold">Student Support</div>
            <span class="sectionstyle"></span>
          </div>
          <h4
            class="my-3 contentheader text-center"
          ...
          <div class="row">
            <div class="col-lg-6">
              <p>
                We provide a learning environment that’s inclusive, socially
                aware and safe, supporting you all the way through your studies.
                You'll have access to Success Coaches, health and wellbeing
                initiatives, and student-led organisations.
              </p>
              <div class="mt-4">
              ...
              <div class="mt-5 row gy-3">
                <div class="col-lg-6 col-md-6">
                  ...
                  >
                    <div class="card-body">
                      <i
                        class="fa-solid iconfonts fa-lightbulb primarycolor p-3 rounded-2"
                      ></i>
                      <h5 class="card-title fw-bold mt-3">Industry Experts</h5>

                      <p class="card-text">
                        Our team of dedicated Success Coaches are on hand to
                        help you throughout your studies, from choosing the
                        right classes to preparing your CV and applying for
                        graduate jobs.
                      </p>
                      <a
                        href="#"
                        class="mt-2 text-decoration-none primarycolor readmore"
                        >Meet Our Industry Experts<i
                ...
                <div class="col-lg-6 col-md-6">
                  ...
                  >
                    <div class="card-body">
                      <i
                        class="fa-solid fa-graduation-cap iconfonts primarycolor p-3 rounded-2"
                      ></i>
                      ...
                      <p class="card-text">
                        Our team of Student Advisors is here to provide
                        comprehensive guidance and support, assisting you in
                        exploring a myriad of study options and helping you
                        discover potential career pathways.
                      </p>
                      <a
                        href="contact-us.html"
                        class="mt-2 text-decoration-none primarycolor readmore"
                        >Contact Student Counselor<i
                          class="ms-1 fa fa-caret-right primarycolor"
                        ></i
                      ></a>
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
              <div>
                <img src="./img/student-support.svg" alt="student-support" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="owl-carousel">
            <div class="mb-2">
              <div class="card border-0 shadow h-100">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text pt-2">Ready to apply? Let us help you</p>
                  <a
                    href="how-to-apply.html"
                    class="mt-2 text-decoration-none primarycolor readmore"
                    >Apply Now<i
                      class="ms-1 fa fa-caret-right primarycolor align-middle"
                    ></i
                  ></a>
                </div>
              </div>
            ...
            <div class="">
              <div class="card border-0 shadow h-100">
                <img
                  src="./img/info-three.png"
                  class="card-img-top"
                  alt="course"
                />
                <div class="card-body">
                  <h5 class="card-title fw-bold">Admission and Fees</h5>
                  <p class="card-text pt-2">Ready to apply? Let us help you</p>
                  <a
                    href="fees.html"
                    class="mt-2 text-decoration-none primarycolor readmore"
