...
<html lang="en">
  ...
  <body>
    ...
    <section class="border-top">
      ...
      <!--Key Dates-->
      <div class="aboutbg py-lg-0 py-4 section-banner">
        <div class="container">
          <div class="row">
            <div class="col-lg-6 d-lg-flex align-items-center">
              <div>
                <h1 class="admssion-font fw-bold">Fees & Scholarship</h1>
                <p>
                  Equip yourself with all the information you need to know about
                  tuition fees and our wide range of scholarships, aimed at
                  supporting you and your education.
                </p>
              </div>
            </div>
            <div class="col-lg-6 mt-lg-5">
              <img src="./img/fees.svg" alt="keydates" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row gy-4">
          ...
          >
            <div class="card border-0 shadow-lg h-100">
              <div class="card-body">
                <h6 class="lato-font fw-bold">Onshore Students Fees</h6>
                <p>
                  Already in Australia? ANE College offers clear fee structures
                  designed for onshore students in Australia, ensuring
                  transparency, and accessibility. With flexible payment options
                  and financial...
                </p>
                <a href="#" class="mt-2 text-decoration-none primarycolor"
                  >Learn More<i
                    class="ms-1 fa fa-caret-right align-middle primarycolor"
                  ></i
                ></a>
              </div>
            </div>
          ...
          >
            <div class="card border-0 shadow-lg h-100">
              <div class="card-body">
                <h6 class="lato-font fw-bold">Offshore Student Fees</h6>
                <p>
                  For international students looking to study in Australia, ANE
                  College provides transparent fee structures tailored to you
                  educational journey. With clear pricing and flexible payment
                  options....
                </p>
                <a href="#" class="mt-2 text-decoration-none primarycolor"
                  >Learn More<i
          ...
          >
            <div class="card border-0 shadow-lg">
              <div class="card-body">
                <h6 class="lato-font fw-bold">Other fees and costs</h6>
                <p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-7 order-lg-1">
            ...
            <p>
              You could be eligible for one of the hundreds of partial
              scholarships we award every year. Learn about scholarship types,
              payment methods and how
            </p>
            <div class="card col-lg-8 mt-lg-5">
              <div class="card-body px-lg-4">
                <div
                  class="d-lg-flex justify-content-start gap-5 align-items-center"
                >
                  <div>
                    <p><b>Enrolment Status</b></p>
