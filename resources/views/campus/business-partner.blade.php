...
<html lang="en">
  ...
  <body>
    ...
    <section class="border-top">
      ...
      <div class="business-portal">
        <div class="container pt-3">
          <h1 class="lato-font fw-bold pt-lg-5 pt-md-5 pt-3 text-white mb-3">
              ...
              <div class="card h-100 bg-color">
                <div class="card-body">
                  <h6 class="fw-bold text-center">
                    <i
                      class="fa-regular fa-handshake me-2 fa-xl align-middle seccolor"
                    ></i>
                    Do you need New Business Partner?
                  </h6>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="card h-100 bg-color">
                <div class="card-body">
                  <h6 class="fw-bold text-center">
                    <i
                      class="fa-regular fa-pen-to-square me-2 seccolor fa-lg align-middle"
                    ></i>
                    Do you need to update your business Partner Details?
                  </h6>
                  <div class="my-4 text-center">
                    <a href="#" class="custom-button">
                      Update Details<i
    ...
    <section class="aboutus">
      <div class="container">
        <div class="py-lg-5 py-3 d-lg-block d-md-block d-none">
          <div class="row">
            <div class="col-lg-4 col-md-4 mb-3 mb-lg-0">
              <input
                type="text"
                class="form-control rounded-pill r"
            ...
            <div class="col-lg-2 col-md-2">
              <div class="mt-1 col">
                <a href="#" class="custom-button"> Search</a>
              </div>
            </div>
          </div>
        </div>
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6">
            <div class="card border-0 shadow h-100">
              <div class="position-relative">
                <img
                  src="https://slc.edu.au/img/footerlogo.png"
                  height="100"
                  alt="slc"
              ...
              <div class="card-body">
                <div>
                  <h5 class="text-center seccolor border-bottom pb-3">
                    Silverline College
                  </h5>
                </div>
                <table>
                  <tr>
                    <td class="pe-3 py-2 fw-bold">Contact</td>
                    <td>Pranab Chalise</td>
                  </tr>
                  <tr>
                    <td class="pe-3 py-2 fw-bold">Phone</td>
                    <td>+61 413 232 786</td>
                  </tr>
                  <tr>
                    <td class="pe-3 py-2 fw-bold">Email</td>
                    <td>ceo@slc.edu.au</td>
                  </tr>
                  <tr>
                    <td class="pe-3 py-2 fw-bold">
                      <p>Address</p>
                    </td>
                    <td>
                      Suite 701, Level 7, 280-282 Pitt Street, Sydney NSW 2000
                    </td>
                  </tr>
                  <tr>
                    <td class="pe-3 py-2 fw-bold">Website</td>
                    <td>www.slc.edu.au</td>
                  </tr>
                </table>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card border-0 shadow h-100">
              <div class="position-relative">
                <img
                  src="https://support.tekgro.com.au/uploads/company/ed2ec079680c57617294e641b4161e1f.png"
                  height="100"
                  alt="slc"
                  class="d-block mx-auto mt-3"
                />
