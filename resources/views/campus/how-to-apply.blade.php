...
<html lang="en">
  ...
  <body>
    ...
    <!-- Slider Bar -->
    <section>
      <div class="position-relative applybar section-banner">
    ...
    <section class="top-padding">
      <div class="container">
        <div class="d-flex align-items-center gap-2">
          <div class="sectionheader d-block fw-bold">Things to Remember</div>
          <span class="sectionstyle"></span>
        </div>
        <h4 class="my-3 contentheader" data-aos="zoom-in" data-aos-delay="100">
          Information To Consider Before You Apply
        </h4>
        <div class="row gy-4 mt-lg-2">
          <div class="col-lg-4">
            <a href="key-dates.html" class="text-decoration-none">
              <div class="card border-0 shadow-lg h-100">
                <div
                  class="card-body d-flex justify-content-between align-items-center"
                >
                  <h6 class="lato-font fw-bold">Key Dates</h6>
                  <i class="arrow-icon d-block fas fa-chevron-right"></i>
                </div>
              </div>
            </a>
          </div>
          <div class="col-lg-4">
            <a href="fees.html" class="text-decoration-none">
              <div class="card border-0 shadow-lg h-100">
                <div
                  class="card-body d-flex justify-content-between align-items-center"
                >
                  <h6 class="lato-font fw-bold">Fees</h6>
                  <i class="arrow-icon d-block fas fa-chevron-right"></i>
                </div>
              </div>
            </a>
          ...
          <div class="col-lg-4">
            <a href="under-construction.html" class="text-decoration-none">
              <div class="card border-0 shadow-lg h-100">
                <div
                  class="card-body d-flex justify-content-between align-items-center"
                >
                  <h6 class="lato-font fw-bold">Admission Criteria</h6>
                  <i class="arrow-icon d-block fas fa-chevron-right"></i>
                </div>
              </div>
            </a>
            ...
            <a href="fees.html" class="text-decoration-none">
              <div class="card border-0 shadow-lg h-100">
                <div
                  class="card-body d-flex justify-content-between align-items-center"
                >
                  <h6 class="lato-font fw-bold">Scholarship</h6>
                  <i class="arrow-icon d-block fas fa-chevron-right"></i>
                </div>
              </div>
            </a>
            ...
            <a href="#" class="text-decoration-none">
              <div class="card border-0 shadow-lg h-100">
                <div
                  class="card-body d-flex justify-content-between align-items-center"
                >
                  <h6 class="lato-font fw-bold">Course Credits</h6>
                  <i class="arrow-icon d-block fas fa-chevron-right"></i>
                </div>
              </div>
            </a>
      ...
      <div class="aboutbg py-5">
        <div class="container">
          <div class="d-flex align-items-center gap-2 justify-content-center">
            <span class="sectionstyle"></span>
            <div class="sectionheader d-block fw-bold">How To Apply</div>
            <span class="sectionstyle"></span>
          </div>
          <h4
          ...
          <div class="mx-auto mt-lg-4">
            <div class="d-lg-flex justify-content-center gap-5">
              <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="card border-0 shadow-lg h-100">
                  <div class="card-body">
                    <h6 class="lato-font fw-bold mb-3">
                      Domestic Applicant
                      <i class="fa-solid fa-globe ms-1"></i>
                    </h6>
                    <p>
                      You are an international student if your are an Australian
                      citizen, Australian permanent resident or permanent visa
                      holder.
                    </p>
                  </div>
                </div>
              ...
              <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="card border-0 shadow-lg h-100">
                  <div class="card-body">
                    ...
                    <p>
                      You are an international student if your are a citizen of
                      another country who is not living in Australia on a
                      permanent visa.
                    </p>
                  </div>
                </div>
    ...
    <!-- Study Type Section Section-->
    <section class="top-padding aboutus">
      <div class="container">
        <div class="d-flex align-items-center gap-2">
          <div class="sectionheader d-block fw-bold">Choose Type</div>
          <span class="sectionstyle"></span>
        </div>

        <h4 class="my-3 contentheader" data-aos="zoom-in" data-aos-delay="100">
          Choose The Type Of Study You Want To Apply For
        </h4>

        <!-- Study Card Section-->
        <div class="row gy-4 mt-lg-1">
          <div class="col-lg-4 col-md-6">
            <div class="card border-0 shadow h-100">
              <div class="position-relative">
                <img
                  src="./img/interactive-clasroom.svg"
                  class="card-img-top"
                  alt="course"
                />
              </div>
              <div class="card-body">
                <h5 class="card-title fw-bold lato-font">
                  Undergraduate Program
                </h5>
                <p class="card-text">
                  Explore Bachelor’s degree, diploma and honors degree
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="card border-0 shadow h-100">
              ...
              <div class="card-body">
                ...
                <p class="card-text">
                  View Master’s degree, graduate diploma and graduate
                  certificate
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card border-0 shadow h-100">
              ...
              <div class="card-body">
                <h5 class="card-title fw-bold lato-font">Research</h5>
                <p class="card-text">
                  Investigate and discover your own research
                </p>
              </div>
            </div>
          </div>
    ...
    <section class="top-padding">
      <div class="aboutbg py-5">
        <div class="container">
          <div class="d-flex align-items-center gap-2">
            <div class="sectionheader d-block fw-bold">Entry Made Easy</div>
            <span class="sectionstyle"></span>
          </div>
          <h4
            ...
            data-aos-delay="100"
          >
            Alternative Pathways To ANE
          </h4>
          <p>
            We welcome individuals with a range of educational, work and life
            experience, so we offer alternative pathways to the course you want
            to do. Whether you’re a high school graduate and didn’t get the ATAR
            you were hoping for or you’ve been out of formal education for a few
            years, we will assess you on your unique strengths and experience.
          </p>
          <div class="row gy-4">
            <div
            ...
            >
              <div class="card border-0 shadow-lg h-100">
                <div class="card-body">
                  <h6 class="lato-font fw-bold primarycolor">
                    Admission Pathways
                  </h6>
                  <p>
                    Didn’t meet our entry requirements? Don’t worry, there are
                    many ways to study with us.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div class="card border-0 shadow-lg">
                <div class="card-body">
                  <h6 class="lato-font fw-bold primarycolor">
                    Current Student and Alumini
                  </h6>
                  <p>
                    Studied with us before? You might be able to apply for
                    readmission, transfer your course or campus, or take
                    advantage of the alumni discount.
                  </p>
                </div>
              </div>
            </div>
    ...
    <section class="top-padding">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <img src="./img/video-guide.svg" alt="videoguide" />
          </div>
          <div class="col-lg-6 ps-lg-4">
            ...
            <p class="mt-2">
              We understand the application process can be overwhelming. This
              video guide will take you step-by-step through the application
              portal, from organising your documents to submitting your
              application.
            </p>
            <!-- <div class="mt-lg-5 mt-3">
              <a
                href=""
                class="fw-bold text-decoration-none text-dark d-flex align-items-center gap-3"
                ><i
                  class="fa-solid fa-circle-play d-block"
            ...
            <div class="item">
              <div class="row">
                <div class="col-lg-6 col-md-6 order-lg-2 order-md-2">
                  <img src="./img/blog-one.png" alt="blog" />
                </div>
                <div class="col-lg-6 col-md-6 order-lg-1 order-md-2">
                  <div class="p-3 bg-white shadow mt-lg-5">
                    <h5 class="lato-font fw-bold">Student Accommodation</h5>
                    <p>
                      We offer you a wide range of catered and self-catered
                      student residences and a vibrant campus community within
                      easy walking or cycling distance to the city. We offer you
                      a wide range of catered and self-catered student
                      residences and a vibrant campus community within easy
                      walking or cycling distance to the city.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="container">
          <div class="row py-5">
            <div class="col-lg-6 col-md-6">
              <div class="text-white mt-lg-0 mt-md-4">
                <h2
                  class="admssion-font font-bold"
                  data-aos="zoom-in"
                  data-aos-delay="100"
                >
                ...
                <p>
                  We're here to support you every step of the way. Our advisors
                  are available to speak to you one-on-one about your study
                  opyions, applicaton process, pathways to your dream degree and
                  more.
                </p>
              </div>
            </div>
            ...
            >
              <div class="text-white text-center">
                <div
                  class="d-lg-flex justify-content-center gap-4 align-items-center"
                >
                  <div class="mb-lg-0 mb-3">
                    <h5>Domestic Students</h5>
                    <p>
                      <i class="fa-solid fa-phone me-2 align-middle"></i>1300
                      711 389
                    </p>
                    <div class="mt-4">
...
<div class="header-call">
  <div class="icon-btn style4"></div>
  <div class="media-body">
    <span class="media-label">24/7 Support Center</span>
    <a class="media-number" href="tel:0478 073 722">0478 073 722</a>
  </div>
</div>
