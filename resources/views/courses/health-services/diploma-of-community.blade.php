      ...
      <div class="container">
        <div class="row py-lg-5 py-3">
          ...
          <div class="col-lg-6 order-lg-1 d-block mt-lg-0 mt-2">
            <h5 class="fw-bold mb-3 primarycolor mt-lg-5">Health Services</h5>
        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <p>
              ...
              <br />At this level, workers have specialised skills in community
              ...
              undertake case management and program coordination. <br />
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="pb-3">
                        101 weeks, including 80 study weeks and 21 weeks of
                        study break.
                      </td>
                    </tr>
      ...
      <div class="bg-color py-4">
        <div class="container">
          ...
          <p class="mt-3">
            ...
            opportunities. Potential employment options are in community
            services roles that focus on the delivery, management and
            coordination of person-centred services to individuals, groups, and
            communities. Further education pathways may include the CHC62015
            Advanced Diploma of Community Sector Management or higher education
            qualifications in community services management.
          </p>
        </div>
      </div>
    </section>
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered">
                  <tr>
                    ...
                    <td>
                      CHC52021 Diploma of Community Services requires the
                      successful completion of 12 core units
                    </td>
                  </tr>
                  <th class="py-3">Core Subjects</th>
                  <tr>
                    <td>CHCCCS004</td>
                    <td>Assess co-existing needs-Core</td>
                  </tr>
                  <tr>
                    <td>CHCCCS007</td>
                    <td>Develop and implement service programs-Core</td>
                  </tr>
                  <tr>
                    <td>CHCCCS019</td>
                    <td>Recognise and respond to crisis situations-Core</td>
                  </tr>
                  <tr>
                    <td>CHCCSM013</td>
                    <td>Facilitate and review case management-Core</td>
                  </tr>
                  <tr>
                    <td>CHCDEV005</td>
                    <td>
                      Analyse impacts of sociological factors on clients in
                      community work and services-Core
                    </td>
                  </tr>
                  <tr>
                    <td>CHCDFV001</td>
                  ...
                  <tr>
                    <td>CHCDIV001</td>
                    <td>Work with diverse people-Core</td>
                  </tr>
                  <tr>
                    <td>CHCDIV002</td>
                    <td>
                  ...
                  <tr>
                    <td>CHCLEG003</td>
                    <td>Manage legal and ethical compliance-Core</td>
                  </tr>
                  <tr>
                    <td>CHCMGT005</td>
                    <td>
                  ...
                  <tr>
                    <td>HLTWHS003</td>
                    <td>Maintain work health and safety-Core</td>
                  </tr>
                </table>
              </div>
            </div>
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered">
                  <tr>
                    ...
                    <td>
                      CHC52021 Diploma of Community Services requires the
                      successful completion of 8 elective units
                    </td>
                  </tr>
                  <th class="py-3">Elective Subjects</th>
                  <tr>
                    <td>CHCCSM009</td>
                    <td>Facilitate goal-directed planning-Group A elective</td>
                  </tr>
                  <tr>
                    <td>CHCCSM010</td>
                    <td>Implement case management practice-Group A elective</td>
                  </tr>
                  <tr>
                    <td>CHCCSM012</td>
                    <td>
                      Coordinate complex case requirements-Group A elective
                    </td>
                  </tr>
                  <tr>
                    <td>CHCCSM014</td>
                    <td>
                      Provide case management supervision-Group A elective
                    </td>
                  </tr>
                  <tr>
                    <td>CHCCSL002</td>
                    <td>
                      Apply specialist interpersonal and counselling
                      skills-Group E elective (ACWA requirement)
                    </td>
                  </tr>
                  <tr>
                    <td>CHCDIS017</td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      with complex needs-Group E elective
                    </td>
                  </tr>
                  <tr>
                    <td>BSBLDR411</td>
                    <td>
                      Demonstrate leadership in the workplace-Imported elective
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <div class="row mt-lg-5 mt-3">
                ...
                <div class="col-lg-9">
                  <p>
                    ...
                    important. Please read the Student Handbook carefully for
                    more information. You will also be provided with further
