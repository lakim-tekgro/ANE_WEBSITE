...
<html lang="en">
  ...
  <body>
    ...
    <!--Banner Section-->
    <section class="bg-color section-banner">
      <div class="container">
        <div class="row py-lg-5 py-3">
          ...
          <div class="col-lg-6 order-lg-1">
            <h1 class="lato-font fw-bold mt-lg-0 mt-2">Health Services</h1>
            <p class="mt-3">
              Learn about the scientific and important aspects of Health
              Services
            </p>
            <div class="mt-4">
              <a href="#" class="custom-button">
                Apply Now<i class="fa fa-angle-double-right ms-2 text-white"></i
              ></a>
            </div>
          </div>
        </div>
    ...
    <!--  Event To Attend Section-->
    <section class="top-padding">
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-5">
            <div class="card positionsticky">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                  <span class="lato-font fw-bold">Filter</span>
                  <span class="lato-font fw-bold primarycolor">Clear All</span>
                </div>
                <hr />
                <!--  Accordion One-->
                ...
                <div class="accordion" id="accordionPanelsStayOpenExample">
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button
                        class="accordion-button fw-bold lato-font"
                        type="button"
                        data-bs-toggle="collapse"
          ...
          <div class="col-lg-8 col-md-7">
            <h4
              ...
              data-aos-delay="100"
            >
              Find a Support Course
            </h4>
            <hr />
            <!--  Course One-->
            <div
              class="card borderwarning border-5 shadow-lg border-top-0 border-bottom-0 border-end-0 rounded-4"
            >
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-7 px-lg-4 border-right">
                    <h5 class="lato-font fw-bold">
                      CHC43015-Certificate IV in Ageing Support
                    </h5>
                    <p class="py-0 my-0">
                      This qualification reflects the role of support workers
                      who complete specialised tasks and functions in aged
                      services; either in residential, home or community-based
                      environments. Workers will take responsibility for their
                      own outputs within defined organisation guidelines and
                      maintain quality service delivery through the development,
                      facilitation and review of individualised service.
                    </p>
                    <h6 class="fw-bold mt-2">CRICOS 112216H</h6>
                    <div class="mt-lg-4 mt-3">
                      <a
                        href="certificate-IV-ageing.html"
                        class="custom-button"
                      >
                        See Full Course Detail<i
                          class="fa fa-angle-double-right ms-2 text-white"
                        ></i
                      ></a>
                    </div>
                  ...
                  <div class="col-lg-5 d-flex align-items-center mt-lg-0 mt-3">
                    <div>
                      <p class="lato-font">
                        <i
                          class="fa-solid fa-location-dot align-middle me-2 primarycolor"
                        ></i
                        >Sydney | Canberra
                      </p>
                      <p class="lato-font">
                        <i
                          class="fa-solid fa-clock align-middle me-2 primarycolor"
                        ></i
                        >52 weeks duration
                      </p>
                      <p class="lato-font py-0 my-0">
                        <i class="fa-solid fa-calendar me-2 primarycolor"></i
                        >Intake
                      </p>
                      <p class="lato-font py-0 my-0 ms-3 fw-bold">
                        Semester 1 intake: Beginning February 2024 Applications
                        open August 2023
                      </p>
                    </div>
                  </div>
            ...
            <!--  Course Two-->
            <div
              class="card borderwarning border-5 shadow-lg border-top-0 border-bottom-0 border-end-0 rounded-4 mt-3"
            >
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-7 px-lg-4 border-right">
                    ...
                    <p class="py-0 my-0">
                      This qualification reflects the role of individuals in the
                      community, home or residential care setting who work under
                      supervision and delegation as a part of a
                      multi-disciplinary team, following an individualised plan
                      to provide person-centred support to people who may
                      require support due to ageing, disability or some other
                      reason.
                    </p>
                    <h6 class="fw-bold mt-2">CRICOS 114658K</h6>
                    <div class="mt-lg-4 mt-3">
                      <a
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-7 px-lg-4 border-right">
                    ...
                    <p class="py-0 my-0">
                      This qualification reflects the role of community services
                      workers involved in the delivery,management and
                      coordination of person-centred services to individuals,
                      groups, and communities. At this level, workers have
                      specialised skills in community services and work
                      autonomously within their scope of practice under broad
                      directions from senior management.
                    </p>
                    <h6 class="fw-bold mt-2">CRICOS 114660E</h6>
                    <div class="mt-lg-4 mt-3">
                      <a href="diploma-of-community.html" class="custom-button">
                        See Full Course Detail<i
                          class="fa fa-angle-double-right ms-2 text-white"
                        ></i
                      ></a>
