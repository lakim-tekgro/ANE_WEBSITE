        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <p>
              ...
              of outputs of others within limited parameters. <br />
      ...
      <div class="bg-color py-4">
        <div class="container">
          ...
          <p class="mt-3">
            ...
            opportunities. Potential employment options are as a direct support
            worker in aged care, disability, home and community care or other
            direct care work in the community services industry. Further
            education pathways may include the CHC52015 Diploma of Community
            Services or a range of other community services qualifications.
          </p>
        </div>
      </div>
    </section>
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered">
                  <tr>
                    ...
                    <td>
                      CHC43015 Certificate IV in Ageing Support requires the
                      successful completion of 15 core units
                    </td>
                  </tr>
                  <th class="py-3">Core Subjects</th>
                  <tr>
                    <td>CHCADV001</td>
                    <td>Facilitate the interests and rights of clients-Core</td>
                  </tr>
                  <tr>
                    <td>CHCAGE001</td>
                    <td>Facilitate the empowerment of older people-Core</td>
                  </tr>
                  <tr>
                    <td>CHCAGE003</td>
                    <td>Coordinate services for older people-Core</td>
                  </tr>
                  <tr>
                    <td>CHCAGE004</td>
                    <td>
                      Implement interventions with older people at risk-Core
                    </td>
                  </tr>
                  <tr>
                    <td>CHCAGE005</td>
                    <td>Provide support to people living with dementia-Core</td>
                  </tr>
                  <tr>
                    <td>CHCCCS006</td>
                    <td>
                      Facilitate individual service planning and delivery-Core
                    </td>
                  </tr>
                  <tr>
                    <td>CHCCCS011</td>
                    <td>Meet personal support needs-Core</td>
                  </tr>
                  <tr>
                    <td>CHCCCS023</td>
                    <td>Support independence and wellbeing-Core</td>
                  </tr>
                  <tr>
                    <td>CHCCCS025</td>
                    <td>Support relationships with carers and families-Core</td>
                  </tr>
                  <tr>
                    <td>CHCDIV001</td>
                  ...
                  <tr>
                    <td>CHCPAL001</td>
                    <td>
                      Deliver care services using a palliative approach-Core
                    </td>
                  </tr>
                  <tr>
                    <td>CHCPRP001</td>
                  ...
                  <tr>
                    <td>HLTAAP001</td>
                    <td>Recognise healthy body systems-Core</td>
                  </tr>
                  <tr>
                    <td>HLTWHS002</td>
                    <td>
                      Follow safe work practices for direct client care-Core
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered">
                  <tr>
                    ...
                    <td>
                      CHC43015 Certificate IV in Ageing Support requires the
                      successful completion of 3 elective units
                    </td>
                  </tr>
                  <th class="py-3">Elective Subjects</th>
                  <tr>
                    <td>CHCDIV003</td>
                    <td>Manage and promote diversity-Elective</td>
                  </tr>
                  <tr>
                    <td>BSBWOR204</td>
                    <td>Use business technology-Elective</td>
                  </tr>
                  <tr>
                    <td>HLTWHS004</td>
                    <td>Manage work health and safety-Elective</td>
                  </tr>
                </table>
              </div>
            </div>
