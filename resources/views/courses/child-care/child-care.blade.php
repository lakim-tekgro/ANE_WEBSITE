      ...
      <div class="container">
        <div class="row py-lg-5 py-3">
          ...
          <div class="col-lg-6 order-lg-1">
            <h1 class="lato-font fw-bold mt-lg-0 mt-2">
              Early Childhood Education
            </h1>
            <p class="mt-3">
              Learn about the scientific and important aspects of Early
              Childhood Education
            </p>
            <div class="mt-4">
                ...
                <div class="row">
                  <div class="col-lg-7 px-lg-4 border-right">
                    ...
                    <p class="py-0 my-0">
                      ...
                      childhood education and care who work in regulated
                      children’s education and care services in Australia. They
                      support children’s wellbeing, and development in the
                      context of an approved learning framework.
                    </p>
                    <h6 class="fw-bold mt-2">CRICOS 112208H</h6>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-7 px-lg-4 border-right">
                    ...
                    <h6 class="fw-bold mt-2">CRICOS 112215J</h6>
                    <div class="mt-lg-4 mt-3">
                      <a href="#" class="custom-button">
                        See Full Course Detail<i
                          class="fa fa-angle-double-right ms-2 text-white"
