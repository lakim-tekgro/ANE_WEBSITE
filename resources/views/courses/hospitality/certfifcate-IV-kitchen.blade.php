      ...
      <div class="container">
        <div class="row py-lg-5 py-3">
          ...
          <div class="col-lg-6 order-lg-1 d-block mt-lg-0 mt-2">
            <h5 class="fw-bold mb-3 primarycolor mt-lg-5">Hospitality</h5>
        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <p>
              ...
              discretion to solve non-routine problems. <br />
              ...
              or to run a small business in these sectors. <br />
              ...
              standards and industry codes of practice. <br />
            ...
            <div class="card">
              <div class="card-body">
                <table>
                  <tbody>
                    <tr>
                      <td class="pe-lg-5 pe-2 fw-bold pb-3">
                        <i
                    ...
                    <tr>
                      ...
                      <td class="pb-3">
                        78 weeks, including 60 study weeks and 18 weeks of
                        holidays.
                      </td>
                    </tr>
      ...
      <div class="bg-color py-4">
        <div class="container">
          ...
          <p class="mt-3">
            ...
            opportunities. Potential employment options are in the commercial
            cookery sector in the roles such as chef and cooks who have a
            supervisory or team leading role in the kitchen. Further education
            pathways may include a range of Diploma qualifications, such as the
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered">
                  <tr>
                    ...
                    <td>
                      SIT40521 Certificate IV in Kitchen Management requires the
                      successful completion of 27 core units
                    </td>
                  </tr>
                  <th class="py-3">Core Subjects</th>
                  <tr>
                    <td>SITHCCC023*</td>
                    <td>Use food preparation equipment-Core</td>
                  </tr>
                  <tr>
                    <td>SITHCCC027*</td>
                    <td>Prepare dishes using basic methods of cookery-Core</td>
                  </tr>
                  <tr>
                    <td>SITHCCC028*</td>
                    <td>Prepare appetisers and salads-Core</td>
                  </tr>
                  <tr>
                    <td>SITHCCC029*</td>
                    <td>Prepare stocks, sauces and soups-Core</td>
                  </tr>
                  <tr>
                    <td>SITHCCC030*</td>
                    <td>
                  ...
                  <tr>
                    <td>SITHCCC031*</td>
                    <td>Prepare vegetarian and vegan dishes-Core</td>
                  </tr>
                  <tr>
                    <td>SITHCCC031*</td>
                    <td>Prepare vegetarian and vegan dishes-Core</td>
                  ...
                  <tr>
                    <td>SITHCCC035*</td>
                    <td>Prepare poultry dishes-Core</td>
                  </tr>
                  <tr>
                    <td>SITHCCC036*</td>
                    <td>Prepare meat dishes-Core</td>
                  </tr>
                  <tr>
                    <td>SITHCCC037*</td>
                    <td>Prepare seafood dishes-Core</td>
                  </tr>
                  <tr>
                    <td>SITHCCC041*</td>
                    <td>Produce cakes, pastries and breads-Core</td>
                  </tr>
                  <tr>
                    <td>SITHCCC042*</td>
                    <td>
                  ...
                  <tr>
                    <td>SITHCCC043*</td>
                    <td>Work effectively as a cook-Core</td>
                  </tr>
                  <tr>
                    <td>SITHKOP010</td>
                    <td>Plan and cost recipes-Core</td>
                  </tr>
                  <tr>
                    <td>SITHKOP012*</td>
                    <td>
                  ...
                  <tr>
                    <td>SITHKOP013*</td>
                    <td>Plan cooking operations-Core</td>
                  </tr>
                  <tr>
                    <td>SITHKOP015*</td>
                    <td>Design and cost menus-Core</td>
                  </tr>
                  <tr>
                    <td>SITHPAT016*</td>
                    <td>Produce desserts-Core</td>
                  </tr>
                  <tr>
                    <td>SITXCOM010</td>
                    <td>Manage conflict-Core</td>
                  </tr>
                  <tr>
                    <td>SITXFIN009</td>
                    <td>Manage finances within a budget-Core</td>
                  </tr>
                  <tr>
                    <td>SITXFSA005</td>
                    <td>Use hygienic practices for food safety-Core</td>
                  </tr>
                  <tr>
                    <td>SITXFSA006</td>
                    <td>Participate in safe food handling practices-Core</td>
                  </tr>
                  <tr>
                    <td>SITXFSA008*</td>
                    <td>Develop and implement a food safety program-Core</td>
                  </tr>
                  <tr>
                    <td>SITXHRM008</td>
                    <td>Roster staff-Core</td>
                  </tr>
                  <tr>
                    <td>SITXHRM009</td>
                    <td>Lead and manage people-Core</td>
                  </tr>
                  <tr>
                    <td>SITXINV006*</td>
                    <td>Receive, store and maintain stock-Core</td>
                  </tr>
                  <tr>
                    <td>SITXMGT004</td>
                    <td>Monitor work operations-Core</td>
                  </tr>
                  <tr>
                    <td>SITXWHS007</td>
                    <td>
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered">
                  <tr>
                    ...
                    <td>
                      SIT40521 Certificate IV in Kitchen Management requires the
                      successful completion of 6 elective units
                    </td>
                  </tr>
                  <th class="py-3">Elective Subjects</th>
                  <tr>
                    <td>SITHCCC039</td>
                    <td>Produce pates and terrines-Elective Group A</td>
                  </tr>
                  <tr>
                    <td>SITHCCC040</td>
                    <td>Prepare and serve cheese-Elective Group A</td>
                  </tr>
                  <tr>
                    <td>SITHCCC044*</td>
                    <td>Prepare specialised food items-Elective Group A</td>
                  </tr>
                  <tr>
                    <td>SITHASC024*</td>
                    <td>Prepare Asian salads-Elective Group B</td>
                  </tr>
                  <tr>
                    <td>SITXWHS006</td>
                    <td>
                  ...
                  <tr>
                    <td>BSBTWK501</td>
                    <td>Lead diversity and inclusion-Elective Group E</td>
                  </tr>
                </table>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="row">
              ...
              <div class="col-lg-9">
                <p>
                  This qualification will be delivered over 78 weeks, including
                  60 study weeks and 18 weeks of holidays.
                </p>
              </div>
              <div class="row mt-lg-5 mt-3">
                ...
                <div class="col-lg-9">
                  <p>
                    Satisfactory course progress and attendance is very
