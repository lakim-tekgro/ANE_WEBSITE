      ...
      <div class="container">
        <div class="row py-lg-5 py-3">
          ...
          <div class="col-lg-6 order-lg-1">
            <h1 class="lato-font fw-bold mt-lg-0 mt-2">Hospitality</h1>
            <p class="mt-3">
              Learn about the scientific and important aspects of Hospitality
              Management
            </p>
            <div class="mt-4">
                ...
                <div class="row">
                  <div class="col-lg-7 px-lg-4 border-right">
                    ...
                    <p class="py-0 my-0">
                      ...
                      senior operators who use a broad range of hospitality
                      skills combined with managerial skills and sound knowledge
                      of industry to coordinate hospitality operations. They
                      operate independently, have responsibility for others and
                      make a range of operational business decisions.
                    </p>
                    <h6 class="fw-bold mt-2">CRICOS 114661D</h6>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-7 px-lg-4 border-right">
                    ...
                    <h6 class="fw-bold mt-2">CRICOS 109585J</h6>
                    <div class="mt-lg-4 mt-3">
                      <a
