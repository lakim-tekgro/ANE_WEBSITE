    ...
    <section class="top-padding">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-7">
            <p>
              This qualification reflects the role of individuals who are job
              ready and competent in a wide range of information and
              communications technology (ICT) roles and apply a broad range of
              skills in varied work contexts, using problem solving skills and
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="pb-3">
                        52 weeks, including 40 study weeks and 12 weeks of
                        holidays.
                      </td>
                    </tr>
      ...
      <div class="bg-color py-4">
        <div class="container">
          ...
          <p class="mt-3">
            ...
            opportunities. Potential employment options are as an independent
            network support technician in a range of industry areas. Further
            education pathways may include ICT50120 Diploma of Information
            Technology or a range of higher education qualifications in
                ...
                <table class="table table-bordered">
                  <tr>
                    ...
                    <td>
                      ...
                      (Networking) requires the successful completion of 7 core
                      units
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>BSBCRT404</td>
                    <td>
                      Apply advanced critical thinking to work processes-Core
                    </td>
                  </tr>
                  <tr>
                    <td>BSBXCS404</td>
                    <td>Contribute to cyber security risk management-Core</td>
                  </tr>
                  <tr>
                    <td>ICTICT426</td>
                    <td>
                      Identify and evaluate emerging technologies and
                      practices-Core
                    </td>
                  </tr>
                  <tr>
                    <td>ICTICT443</td>
                    <td>Work collaboratively in the ICT industry-Core</td>
                  </tr>
                  <tr>
                    <td>ICTICT451</td>
                    <td>
                      Comply with IP, ethics and privacy policies in ICT
                      environments-Core
                    </td>
                  </tr>
                  <tr>
                    <td>ICTPRG302</td>
                    <td>Apply introductory programming techniques-Core</td>
                  </tr>
                  <tr>
                    <td>ICTSAS432</td>
                    <td>Identify and resolve client ICT problems-Core</td>
                  </tr>
                </table>
              </div>
            </div>
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered">
                  <tr>
                    ...
                    <td>
                      ICT40120 Certificate IV in Information Technology
                      (Networking) requires the successful completion of 13
                      elective units
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>ICTWEB452</td>
                    <td>Create a mark-up language document-Elective</td>
                  </tr>
                  <tr>
                    <td>BSBPEF402**</td>
                    <td>Develop personal work priorities-Elective</td>
                  </tr>
                  <tr>
                    <td>ICTNWK422</td>
                    <td>Install and manage servers-Elective</td>
                  </tr>
                  <tr>
                    <td>ICTNWK423</td>
                    <td>Manage network and data integrity-Elective</td>
                  </tr>
                  <tr>
                    <td>ICTNWK425</td>
                    <td>Build small wireless local area networks-Elective</td>
                  </tr>
                  <tr>
                    <td>ICTSAD402</td>
                    <td>
                      Develop and present ICT feasibility reports-Elective
                    </td>
                  </tr>
                  <tr>
                    <td>ICTICT429</td>
                  ...
                  <tr>
                    <td>ICTTEN417</td>
                    <td>Install, configure and test a router-Elective</td>
                  </tr>
                  <tr>
                    <td>ICTTEN420</td>
                    <td>
                      Design, install and configure an internetwork-Elective
                    </td>
                  </tr>
                  <tr>
                    <td>ICTCYS407</td>
                    <td>Gather, analyse and interpret threat data-Elective</td>
                  </tr>
                  <tr>
                    <td>ICTICT425</td>
                    <td>
                      Implement WHS, environmental sustainability and
                      anti-discrimination practices in an ICT workplace-Elective
                    </td>
                  </tr>
                  <tr>
                    <td>ICTPMG505</td>
                    <td>Manage ICT projects-Elective</td>
                  </tr>
                  <tr>
                    <td>BSBXCS402</td>
                    <td>
            ...
            <div class="row">
              ...
              <div class="col-lg-9">
                <p>
                  ...
                  40 study weeks and 12 weeks of holidays.
                </p>
              </div>
