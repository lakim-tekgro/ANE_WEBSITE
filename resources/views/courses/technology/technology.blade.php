      ...
      <div class="container">
        <div class="row py-lg-5 py-3">
          ...
          <div class="col-lg-6 order-lg-1">
            ...
            <p class="mt-3">
              Learn about the scientific and important aspects of Information
              Technology
            </p>
            <div class="mt-4">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-md-7">
            <h4
              ...
              data-aos-delay="100"
            >
              Find a Information Technology Course
            </h4>
            <hr />
            <!--  Course One-->
            <div
                ...
                <div class="row">
                  <div class="col-lg-7 px-lg-4 border-right">
                    ...
                    <p class="py-0 my-0">
                      ...
                      are job ready and competent in a wide range of information
                      and communications technology (ICT) roles and apply a
                      broad range of skills in varied work contexts, using
                      problem solving skills and effective communication with
                      others.
                    </p>
                    <h6 class="fw-bold mt-2">CRICOS 112211B</h6>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-7 px-lg-4 border-right">
                    ...
                    <h6 class="fw-bold mt-2">CRICOS 112212A</h6>
                    <div class="mt-lg-4 mt-3">
                      <a
