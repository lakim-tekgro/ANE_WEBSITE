...
<html lang="en">
  ...
  <body>
        ...
        <div class="row py-4">
          <div class="col-lg-7 col-md-6">
            <div class="card border-0">
              <div class="card-body">
                <h4 class="mb-3 contentheader">Submit an Enquiry</h4>
                <form action="">
                  <div class="row">
                    <div class="col-lg-6 mb-3">
                      <label for="" class="text-muted">Your Name</label>
                    ...
                    <div>
                      <label for="" class="text-muted">How Can I Help?</label>
                      <textarea
                        class="form-control"
                        name="help"
                        id=""
          ...
          <div class="col-lg-5 col-md-6">
            <div class="card primarybg border-0 h-100">
              <div class="card-body mx-lg-4">
                <h4 class="my-3 contentheader text-white">
                  Contact Information
                </h4>
                <div class="my-3">
                  <a
                    class="text-decoration-none text-white"
                    href="tel:+61292815929"
                    ><i class="fa-solid fa-phone me-4 fa-lg align-middle"></i
                    >+61 2 9281 5929</a
                  >
                </div>
                <div class="mb-3">
                  <a
                    class="text-decoration-none text-white"
                    href="mailto:sydney.campus@ane.edu.au"
                    ><i class="fa-solid fa-envelope me-4 fa-lg align-middle"></i
                    >sydney.campus@ane.edu.au</a
                  >
                </div>
                <div>
                  <a class="text-decoration-none text-white"
                    ><i
                      class="fa-solid fa-location-dot me-4 fa-lg align-middle"
                    ></i
                    >View Campus Location</a
                  >
                  <div class="row mt-3">
                    <div class="col-lg-6">
                      <h6 class="text-white">Sydney</h6>
                      <div>
                        <iframe
                          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3312.0962502323187!2d151.2069209!3d-33.8871749!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b12ae20f3852d0b%3A0x340af78d56578901!2s6%2F136%20Chalmers%20St%2C%20Surry%20Hills%20NSW%202010%2C%20Australia!5e0!3m2!1sen!2snp!4v1714108423411!5m2!1sen!2snp"
                          width="200"
                          height="150"
                          style="border: 0"
                          allowfullscreen=""
                    ...
                    <div class="col-lg-6">
                      <h6 class="text-white">Canberra</h6>
                      <div>
                        <iframe
                          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3258.7384811729553!2d149.0686882!3d-35.23787960000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b17ad71c4b9ea21%3A0x455b5d58d1bd5550!2s8%20Chandler%20St%2C%20Belconnen%20ACT%202617%2C%20Australia!5e0!3m2!1sen!2snp!4v1714108434911!5m2!1sen!2snp"
                          width="200"
                          height="150"
                          style="border: 0"
                          allowfullscreen=""
                    ...
                    <div class="mt-4">
                      <a
                        href="https://www.facebook.com/anecollege/"
                        target="_blank"
                        class="text-decoration-none"
                      >
                        <i
                          class="fa-brands fa-lg fa-facebook-f me-3 text-white"
                        ></i></a
                      ><a
                      ...
                      >
                        <i
                          class="fa-brands fa-lg fa-instagram me-3 text-white"
                        ></i></a
                      ><a href="#" target="_blank"
                        ><i
                          class="fa-brands fa-lg fa-tiktok me-3 text-white"
                        ></i></a
                      ><a href="#" target="_blank"
    ...
    <section class="top-padding">
      <div class="container">
        <div class="row">
          <h4 class="my-3 contentheader">For General Information</h4>
          <div class="col-lg-4 col-md-6">
            <div class="card border-0 shadow-lg">
              <div class="card-body">
                <h6 class="fw-bold">General and Student Enquirers</h6>
                <div class="my-3">
                  <a href="" class="text-decoration-none seccolor" href="#"
                    ><i
                      class="fa-solid fa-envelope text-dark me-3 align-middle fa-lg"
                    ></i
                    >universityadmission@gmail.com</a
                  >
                </div>
                <div class="">
                  <a href="" class="text-decoration-none seccolor" href="#"
                    ><i
                      class="fa-solid fa-phone text-dark me-3 align-middle fa-lg"
                    ></i
                    >1300 575 803</a
                  >
                </div>
    ...
    <section class="top-padding">
      <div class="container">
        <div class="row gy-4">
          <h4 class="my-3 contentheader">Specific Departments/ Division</h4>
          <div class="col-lg-4 col-md-6">
            <div class="card border-0 shadow-lg">
              <div class="card-body">
                <h6 class="fw-bold">Admission and Enrollment-Sydney Campus</h6>
                <p class="text-muted">
                  Level 6, 136 Chalmers Street Surry Hills, NSW, Australia 2010
                </p>
                <div class="my-3">
                  <a href="" class="text-decoration-none seccolor" href="#"
                    ><i
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card border-0 shadow-lg">
              <div class="card-body">
                <h6 class="fw-bold">
                  Admission and Enrollment-Canberra Campus
                </h6>
                <p class="text-muted">
                  8 Chandler Street, BELCONNEN, ACT 2617, Australia
                </p>
                <div class="my-3">
                  <a href="" class="text-decoration-none seccolor" href="#"
                    ><i
    ...
    <section class="top-padding">
      <div class="container">
        <div class="row">
          <h4 class="my-3 contentheader">Connect on Social Media</h4>
          <div class="d-flex gap-2">
            <div>
              <i
                class="fa-brands fa-facebook-f p-3 text-white"
                style="background-color: #3a5795"
              ></i>
            </div>
            <div>
              <i
                class="fa-brands fa-x-twitter p-3 text-white"
                style="background-color: black"
              ></i>
            </div>
            <div>
              <i
                class="fa-brands fa-instagram p-3 text-white"
                style="background-color: #32628a"
              ></i>
            </div>
            <div>
              <i
                class="fa-brands fa-youtube p-3 text-white"
