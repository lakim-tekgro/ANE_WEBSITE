...
<html lang="en">
  ...
  <body>
      ...
      <div class="aboutbg">
        ...
        <div class="container">
          <div class="row py-4">
            ...
            <div class="col-lg-6">
              <p class="text-left">
                ANE College invites you on a journey to redefine your future.
                Picture a life where quality education merges seamlessly with
                the vibrant Australian lifestyle. Elevate your career prospects,
                increase your earning potential, and experience the richness of
                living in Australia. ANE equips you with sought-after skills for
                a successful career while supporting your personal growth. Join
                us at ANE College, where education meets lifestyle, and your
                transformative Australian adventure begins.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-6">
            ...
            >
              <i
                class="fa-solid fa-crosshairs align-middle me-2 text-warning"
              ></i
              >Mission and Strategy
            </h4>
            <p class="mt-lg-4">
              ANE College is dedicated to encouraging, supporting, and nurturing
              our students, fostering an environment where growth and
              development thrive. Our mission is to provide not just education
              but a holistic experience that empowers individuals to reach their
              fullest potential. Through unwavering support, we aim to educate
              and shape future leaders who contribute meaningfully to their
              communities and beyond.
            </p>
          </div>
          <div class="col-lg-6 col-md-6">
            <div class="col-lg-11 mt-md-5 mt-lg-0">
              <img src="./img/mission.jpeg" alt="mission" class="aboutimage" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 col-md-6">
              ...
              <p class="mb-lg-5">
                Our vibrant campuses boast world-class facilities,
                architecturally designed buildings and beautiful grounds. Enjoy
                learning and socialising in inspiring and supportive
                environments.
              </p>
              <div class="mb-lg-0 mb-4">
                <a href="campus-tour.html" class="custom-buttonone">
                  Campus Tour<i
                    class="fa fa-angle-double-right ms-2 text-white"
                  ></i
                ></a>
    ...
    <section class="top-padding">
      <div class="container">
        <div
          class="text-center primarybg d-lg-flex justify-content-between align-items-center p-4 rounded-2"
          data-aos="fade-up"
          data-aos-delay="100"
        >
