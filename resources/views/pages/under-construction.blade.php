            ...
            <div class="card border-0 shadow-lg">
              <div class="card-body">
                <div class="text-center mt-3">
                  <i
                    class="fa-solid fa-wrench bg-light p-4 rounded-pill shadow-lg animate-construction"
                    style="font-size: 80px; color: #bf6c27"
                  ></i>
                </div>
                <h2 class="fw-bold text-center my-5" style="color: #bf6c27">
